...
extension String {
    ...
    var phoneCodeFromContryCode : String {
        return "+\(self.phoneCodeFromContryCodeWithoutPlus)"
    }
    var phoneCodeFromContryCodeWithoutPlus : String {
        guard let phoneCode = String.countryPrefixes[self] else { return "" }
        return "\(phoneCode)"
    }
